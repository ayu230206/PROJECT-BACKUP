            ...
            <form action="{{ route('mahasiswa.proyek.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <select name="status_proyek" class="w-full rounded-lg border border-green-400 p-2 mt-1">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="tahun" value="{{ old('tahun', date('Y')) }}" class="w-full rounded-lg border border-green-400 focus:ring-green-600 p-2 mt-1" placeholder="2025">
                    </div>
                </div>

                <button class="bg-green-700 hover:bg-green-900 text-white px-5 py-2 rounded-lg mt-2 shadow font-semibold transition">
                    Tambah Proyek
                </button>
            </form>
        </div>
            ...
            <table class="w-full border text-sm text-left">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-green-100 transition">
                        ...
                        <td class="p-3 border font-semibold">{{ $project->judul }}</td>
                        ...
                        <td class="p-3 border text-center">{{ $project->tahun ?? '-' }}</td>
                        <td class="p-3 border">
